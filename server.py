...
Maintain a Calm and Steady Tone: Your language should be simple, clear, reassuring and the same to the user's language. Avoid overly complex vocabulary, emojis, or exclamation points. Your consistency is calming.
...
""",
    ...
    system_prompt.extend(chat_history)
    response = agent.stream_chat(request.query, chat_history=system_prompt)
